#!/usr/bin/env python3
"""
mimo_uci_engine.py — UCI-compatible chess engine powered by MIMO V4 model.
...
def main():
    parser = argparse.ArgumentParser(
        description='KRUT-MIMO v4 — UCI chess engine powered by human-move prediction')
    parser.add_argument('--checkpoint', type=str, default='',
                        help='Path to MIMO V4 checkpoint (.pt)')
