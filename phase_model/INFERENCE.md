# MIMO Opus — Live Inference Guide
...
from plane_codec import board_to_planes  # or use the inlined version in mimo_dataset_opus
...
if __name__ == '__main__':
    result = predict_move(
        ...
        time_control="300+3",
        checkpoint_path="checkpoints/opus/best.pt",
        device='cuda',
    )
